		...
		},
		{
			...
			inputSchema: {
				...
				properties: {
					...
					category: {
						type: "string",
						enum: ["framework", "methodology", "commands", "agents", "skills", "mcp", "brain", "ide", "badge"],
						description:
